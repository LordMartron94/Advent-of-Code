...
func (p *ParsingRuleFactory) GetPairRule() rules.ParsingRuleInterface[LexingTokenType] {
	return p.factory.NewPairRule("pair", NumberToken, NumberToken, p.GetNumberTokenRule(), p.GetNumberTokenRule())
}

...
import (
	...
	"github.com/LordMartron94/Advent-of-Code/2024/Day-04/pipeline/pipes"
...
func main() {
	...
	fmt.Println(fmt.Sprintf("Final result (task 1): %v", result.Result))
	fmt.Println(fmt.Sprintf("Final result (task 2): %v", result.XMasResult))
}
